...
/* WEBPACK VAR INJECTION */(function(module) {(function (module, exports) {
  ...
  var Buffer;
  try {
    Buffer = __webpack_require__(161).Buffer;
  } catch (e) {
  }
...
hash.utils = __webpack_require__(120);
hash.common = __webpack_require__(116);
hash.sha = __webpack_require__(119);
hash.ripemd = __webpack_require__(118);
...
var EC = __webpack_require__(1).ec;
var ec = new EC('secp256k1');
var LRU = __webpack_require__(22);

var keystore = void 0;
var cache = new LRU(100);

if (typeof localStorage === "undefined" || localStorage === null) {
  var LocalStorage = __webpack_require__(29).LocalStorage;
...
var OrbitCrypto = function () {
  ...
  _createClass(OrbitCrypto, null, [{
    ...
    value: function useKeyStore() {
      ...
      if (typeof localStorage === "undefined" || localStorage === null) {
        var _LocalStorage = __webpack_require__(29).LocalStorage;
        keystore = new _LocalStorage(directory);
      } else {
        keystore = localStorage;
      }
    }
...
var Store = function () {
  ...
  _createClass(Store, [{
    ...
    value: function loadHistory(hash) {
      ...
      if (this._lastWrite.includes(hash)) return Promise.resolve([]);
    ...
    value: function sync(hash) {
      ...
      if (!hash || this._lastWrite.includes(hash)) return Promise.resolve([]);
...
"use strict";
'use strict'
var abortCb = __webpack_require__(33)
...
var take = __webpack_require__(28);
var findIndex = __webpack_require__(126);
var Store = __webpack_require__(17);
var EventIndex = __webpack_require__(24);
...
(function() {
  ...
  writeSync = __webpack_require__(159).sync;
...
var sources  = __webpack_require__(143)
var sinks    = __webpack_require__(137)
var throughs = __webpack_require__(149)
...
var Post = __webpack_require__(5);
var TextPost = __webpack_require__(49);
var PinnedPost = __webpack_require__(47);
var FilePost = __webpack_require__(44);
var DirectoryPost = __webpack_require__(43);
var OrbitDBItem = __webpack_require__(46);
var MetaInfo = __webpack_require__(45);
var Poll = __webpack_require__(48);
...
var EventEmitter = __webpack_require__(7).EventEmitter;
var EventStore = __webpack_require__(25);
var FeedStore = __webpack_require__(57);
var KeyValueStore = __webpack_require__(59);
var CounterStore = __webpack_require__(51);
var DocumentStore = __webpack_require__(55);
var Pubsub = __webpack_require__(60);
var Cache = __webpack_require__(63);
...
var OrbitIdentifyProvider = __webpack_require__(64);
...
var isEqual = __webpack_require__(41).isEqual;
...
var PinnedPost = function (_Post) {
  _inherits(PinnedPost, _Post);

  function PinnedPost(pinned) {
    _classCallCheck(this, PinnedPost);

    var _this = _possibleConstructorReturn(this, (PinnedPost.__proto__ || Object.getPrototypeOf(PinnedPost)).call(this, "pin"));
...
var Counter = __webpack_require__(40);
...
var Store = __webpack_require__(17);
var CounterIndex = __webpack_require__(50);
...
var DocumentIndex = __webpack_require__(54);
...
var DocumentStore = function (_Store) {
  ...
  function DocumentStore(ipfs, id, dbname, options) {
    ...
    return _possibleConstructorReturn(this, (DocumentStore.__proto__ || Object.getPrototypeOf(DocumentStore)).call(this, ipfs, id, dbname, options));
  }
  ...
  _createClass(DocumentStore, [{
    ...
    value: function get(key) {
      ...
      return Object.keys(this._index._index).filter(function (e) {
...
var EventStore = __webpack_require__(25);
var FeedIndex = __webpack_require__(56);
...
var Store = __webpack_require__(17);
var KeyValueIndex = __webpack_require__(58);
...
var KeyValueStore = function (_Store) {
  ...
  function KeyValueStore(ipfs, id, dbname, options) {
    ...
    var opts = Object.assign({}, { Index: KeyValueIndex });
    Object.assign(opts, options);
    return _possibleConstructorReturn(this, (KeyValueStore.__proto__ || Object.getPrototypeOf(KeyValueStore)).call(this, ipfs, id, dbname, opts));
  }
...
var logger = __webpack_require__(13).create("orbit-db.IPFSPubSub");
...
var pull = __webpack_require__(30);
var BlobStore = __webpack_require__(112);
var Lock = __webpack_require__(124);
...
var Crypto = __webpack_require__(16);
var OrbitUser = __webpack_require__(21);
...
var schedule = __webpack_require__(90);
...
var bluebird = __webpack_require__(83)();
...
var async = Promise._async;
var Warning = __webpack_require__(3).Warning;
var util = __webpack_require__(0);
...
var es5 = __webpack_require__(8);
var Async = __webpack_require__(66);
var async = new Async();
...
var APPLY = {};
var NEXT_FILTER = {};
var tryConvertToPromise = __webpack_require__(94)(Promise, INTERNAL);
var PromiseArray =
    __webpack_require__(84)(Promise, INTERNAL,
                               tryConvertToPromise, apiRejection, Proxyable);
var Context = __webpack_require__(72)(Promise);
 /*jshint unused:false*/
var createContext = Context.create;
var debug = __webpack_require__(73)(Promise, Context);
var CapturedTrace = debug.CapturedTrace;
var PassThroughHandlerContext =
    __webpack_require__(77)(Promise, tryConvertToPromise);
var catchFilter = __webpack_require__(71)(NEXT_FILTER);
...
__webpack_require__(81)(Promise, INTERNAL, tryConvertToPromise, apiRejection,
    debug);
__webpack_require__(67)(Promise, INTERNAL, tryConvertToPromise, debug);
__webpack_require__(70)(Promise, PromiseArray, apiRejection, debug);
...
__webpack_require__(80)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug);
__webpack_require__(69)(Promise);
__webpack_require__(96)(Promise, apiRejection, tryConvertToPromise, createContext, INTERNAL, debug);
__webpack_require__(95)(Promise, INTERNAL, debug);
__webpack_require__(78)(Promise, apiRejection, INTERNAL, tryConvertToPromise, Proxyable, debug);
__webpack_require__(82)(Promise);
__webpack_require__(85)(Promise, INTERNAL);
__webpack_require__(86)(Promise, PromiseArray, tryConvertToPromise, apiRejection);
__webpack_require__(88)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
__webpack_require__(89)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug);
__webpack_require__(91)(Promise, PromiseArray, debug);
__webpack_require__(92)(Promise, PromiseArray, apiRejection);
...
var maybeWrapAsError = util.maybeWrapAsError;
var canEvaluate = util.canEvaluate;
var TypeError = __webpack_require__(3).TypeError;
...
var util = __webpack_require__(0);
var RangeError = __webpack_require__(3).RangeError;
var AggregateError = __webpack_require__(3).AggregateError;
var isArray = util.isArray;
var CANCELLATION = {};
...
var _write = __webpack_require__(155);
var _read = __webpack_require__(132);
var fs = __webpack_require__(4);
...
var fs = __webpack_require__(4)
var polyfills = __webpack_require__(115)
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(160).equal(queue.length, 0)
  })
}

module.exports = patch(__webpack_require__(27))
...
var fs = __webpack_require__(4);
var Decoder = __webpack_require__(154)
/**
  # pull-file
...
module.exports = {
  ...
  onEnd: __webpack_require__(139),
  log: __webpack_require__(138),
  find: __webpack_require__(136),
  reduce: __webpack_require__(18),
  collect: __webpack_require__(134),
...
module.exports = {
  ...
  once: __webpack_require__(31),
  values: __webpack_require__(19),
  count: __webpack_require__(140),
  infinite: __webpack_require__(144),
  empty: __webpack_require__(141),
  error: __webpack_require__(142)
}
...
module.exports = {
  ...
  asyncMap: __webpack_require__(146),
  filter: __webpack_require__(20),
  filterNot: __webpack_require__(147),
  through: __webpack_require__(153),
  take: __webpack_require__(152),
  unique: __webpack_require__(32),
  nonUnique: __webpack_require__(151),
  flatten: __webpack_require__(148)
}
...
var unique = __webpack_require__(32)
...
var Decode = __webpack_require__(165).StringDecoder
...
exports.asyncMap = __webpack_require__(156)
exports.bindActor = __webpack_require__(35)
exports.chain = __webpack_require__(157)
...
var chain = __webpack_require__(158).chain
var MurmurHash3 = __webpack_require__(121)
var extend = Object.assign || __webpack_require__(15)._extend
...
var path = __webpack_require__(12);
var EventEmitter = __webpack_require__(7).EventEmitter;
var OrbitDB = __webpack_require__(38);
var Crypto = __webpack_require__(16);
var Post = __webpack_require__(37);
var Logger = __webpack_require__(13);
var LRU = __webpack_require__(22);
var OrbitUser = __webpack_require__(21);
var IdentityProviders = __webpack_require__(39);

var logger = Logger.create("Orbit", { color: Logger.Colors.Green });
__webpack_require__(13).setLogLevel('ERROR');
...
var Orbit = function () {
  ...
  _createClass(Orbit, [{
    ...
    value: function connect() {
      ...
      this._ipfs.object.put(new Buffer(JSON.stringify({ app: 'orbit.chat' }))).then(function (res) {
        return _this._ipfs.object.get(res.toJSON().Hash, { enc: 'base58' });
      });
    ...
    value: function get(channel) {
      var lessThanHash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var greaterThanHash = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
